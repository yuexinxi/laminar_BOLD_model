% Havlicek et Uludag, 2020. Figure 3
...
cbf{1}      = kron(cbf_original.*[1.6 1 1 1 1 1],ones(P{1}.T/P{1}.dt,1));
cbf{2}      = kron(cbf_original.*[1 1.6 1 1 1 1],ones(P{1}.T/P{1}.dt,1));
cbf{3}      = kron(cbf_original.*[1 1 1.6 1 1 1],ones(P{1}.T/P{1}.dt,1));
cbf{4}      = kron(cbf_original.*[1 1 1 1.6 1 1],ones(P{1}.T/P{1}.dt,1));
cbf{5}      = kron(cbf_original.*[1 1 1 1 1.6 1],ones(P{1}.T/P{1}.dt,1));
cbf{6}      = kron(cbf_original.*[1 1 1 1 1 1.6],ones(P{1}.T/P{1}.dt,1));
